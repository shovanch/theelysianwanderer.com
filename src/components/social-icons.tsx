export function AsterikIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg aria-hidden="true" viewBox="0 0 640 640" {...props}>
...
export function ChefIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      height="32"
      viewBox="0 0 256 256"
...
export function SteamIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      height="32"
      viewBox="0 0 256 256"
...
export function ChessIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      aria-hidden="true"
      height="32"
...
export function GamingIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      height="32"
      viewBox="0 0 256 256"
...
export function GoodreadsIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      height="32"
      viewBox="0 0 256 256"
